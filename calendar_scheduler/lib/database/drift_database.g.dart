...
class CategoryColor extends DataClass implements Insertable<CategoryColor> {
  ...
  final DateTime createdAt;
  CategoryColor(
      {required this.id, required this.hexCode, required this.createdAt});
  ...
  CategoryColor copyWith({int? id, String? hexCode, DateTime? createdAt}) =>
      CategoryColor(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, hexCode, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class CategoryColorsCompanion extends UpdateCompanion<CategoryColor> {
  ...
  CategoryColorsCompanion copyWith(
      {Value<int>? id, Value<String>? hexCode, Value<DateTime>? createdAt}) {
    return CategoryColorsCompanion(
      id: id ?? this.id,
      hexCode: hexCode ?? this.hexCode,
      createdAt: createdAt ?? this.createdAt,
...
class $CategoryColorsTable extends CategoryColors
  ...
  late final GeneratedColumn<DateTime?> createdAt = GeneratedColumn<DateTime?>(
      ...
      clientDefault: () => DateTime.now());
  @override
  List<GeneratedColumn> get $columns => [id, hexCode, createdAt];
  @override
